...
int32_t WINAPI VAI_ReadBoardInfo(int32_t DevIndex,PVAI_BOARD_INFO pInfo);
...
int32_t WINAPI VAI_Read3ADCDatas(int32_t DevType,int32_t DevIndex,uint8_t *pData, uint16_t *DataNum); 
int32_t WINAPI VAI_Scope_Control(int32_t DevType,int32_t DevIndex,uint8_t channel,uint8_t on);
int32_t WINAPI VAI_Scope_ReadADCDatas(int32_t DevType,int32_t DevIndex,uint8_t *pData, uint16_t *DataNum,uint16_t* timestamp);
#ifdef __cplusplus
}
#endif
