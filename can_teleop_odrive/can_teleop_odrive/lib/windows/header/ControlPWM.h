...
int32_t	WINAPI VPI_StartPWM3ADC(int32_t DevType, int32_t DevIndex, uint8_t ChannelMask); 
int32_t	WINAPI VPI_StopPWM3ADC(int32_t DevType, int32_t DevIndex, uint8_t ChannelMask); 
