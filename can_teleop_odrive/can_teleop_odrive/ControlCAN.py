...
if(platform.system()=="Windows"):
    ...
    if "64bit" in platform.architecture():
        GinkgoLib = cdll.LoadLibrary( "src/can_teleop_odrive/can_teleop_odrive/lib/linux/64bit/libGinkgo_Driver.so" )
    else:
